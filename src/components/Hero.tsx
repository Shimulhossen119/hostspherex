        ...
        <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="text-left">
              ...
              >
                HostSphereX delivers secure, scalable, and modern hosting
                solutions designed for businesses that demand excellence. From
                startups to enterprises, our platform ensures your online
                presence is fast, reliable, and always available.
              </motion.p>
